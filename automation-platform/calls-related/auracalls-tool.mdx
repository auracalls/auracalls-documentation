---
title: "Aura Calls Tool"
icon: "phone"
description: "Learn how to use Aura Calls triggers and actions in your AI calling flows"
---

# Aura Calls Tool

The Aura Calls tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Aura Calls tool prominently displayed at the top of the
...
![Aura Calls Call Ended Trigger](/resources/auracalls-trigger.jpg)
...
![Aura Calls Action](/resources/auracalls-action.jpg)
