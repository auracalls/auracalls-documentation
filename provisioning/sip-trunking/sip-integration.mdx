---
title: "Overview"
description: "Connect your existing phone system and numbers to Auracalls.ai"
---
...
When you integrate your phone system with Auracalls.ai:
...
You can connect your phone system to Auracalls.ai in two ways:
...
- **Inbound Calls** (VoIP → Auracalls.ai):
...
- **Outbound Calls** (Auracalls.ai → VoIP):
  ```
  AI initiates call
  ↓
...
<Warning>
  ...
  Auracalls.ai dashboard (and vice versa) to maintain the connection.
</Warning>
